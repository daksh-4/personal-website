...
\noindent This frontmatter is how essays get tagged and connected to each other, which matters for both the graph view and the version history described below.
...
Commits that do not carry the \texttt{publish:} prefix --- typo fixes, formatting tweaks --- are invisible to the slider. This keeps the version history intentional: it surfaces genuine drafts rather than every small edit.
...
For viewership tracking I wanted to avoid invasive cookies. I embedded a tiny snippet from \href{https://www.goatcounter.com}{GoatCounter}, an open-source, privacy-friendly analytics tool. It logs only anonymous page views --- no cross-site tracking, no personal data --- so I can see what people are reading without compromising anyone's privacy.
